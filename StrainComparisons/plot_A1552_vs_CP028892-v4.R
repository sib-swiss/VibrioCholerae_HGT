...
#
#           R --vanilla --quiet < plot_A1552_vs_CP028892-v4.R
#
#--------------------------------------------------------------------------------------------------------
...
pdf(file=paste('compareStrains.CP028893.lbl',minLabelDeltaChr1,'.',minLabelDeltaChr2,'.pdf',sep=''),width=30,height=15)
...
match <- LoadFile('Align_Sa5Y_onto_A1552.chr1.maxdel50000.txt','Align_Sa5Y_onto_A1552.chr1.maxdel512.txt',TRUE,NULL)
...
annot$startPos[idx] <- inner.len - annot$startPos[idx]
annot$endPos[idx] <- inner.len - annot$endPos[idx]
...
text(0.0,  0.05, "CP028894 (A1552)", adj = c(0.5,0.5), col=hsv(inner.col,1,1.0) , cex=0.75*textsize)
text(0.0,  0.00, "CP028892 (Sa5Y)", adj = c(0.5,0.5), col='darkgreen', cex=0.75*textsize)
...
match <- LoadFile('Align_Sa5Y_onto_A1552.chr2.maxdel50000.txt','Align_Sa5Y_onto_A1552.chr2.maxdel512.txt',TRUE,FALSE)
match <- cbind(match,delta=match$insCnt - match$delCnt)
...
text(0.0,  0.05, "CP028895 (A1552)", adj = c(0.5,0.5), col=hsv(inner.col,1,1.0) , cex=0.75*textsize)
text(0.0,  0.00, "CP028893 (Sa5Y)", adj = c(0.5,0.5), col='darkgreen' , cex=0.75*textsize) #hsv(outer.col,1,1.0)
